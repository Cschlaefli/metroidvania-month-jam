...
func _phase_one_animation() :
	pass

func _phase_two_animation():
	pass

func _phase_three_animation() :
	pass
...
func _enter_state(new_state, previous_state):
	match new_state :
		states.phase_one :
			$PhaseOneShots.active = true
			_phase_one_animation()
		states.phase_two :
			_phase_two_animation()
		states.phase_three :
			_phase_three_animation()
		states.dead :
			_death_animation()
		_:
			pass